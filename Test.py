...
def openCovid():
    ...
    def totalDailyCases():
        ...
        def open_file():
            ...
            return file
        file3 = open_file()    
        covidData =  pd.read_csv(file3,\
                            index_col = 0, parse_dates = ["date"])
        #slcice table
        cleanCovidData = covidData.loc[:,"areaName":"newCasesBySpecimenDate-unassigned"]
        sumCovidData = cleanCovidData.sum(axis = 1, numeric_only = True)#sum all new cases for different age range
        cleanCovidData['Total number of cases daily'] = sumCovidData #create new column
    ...
    def totalWeeklyCases():
        ...
        hartlepoolFirst30Weeks.plot(kind = "box", y = "Total number of cases daily", x="Week", title="Hartlepool number of cases in first 30 weeks")
    ...
    def changeInCasesOverTimeAndLocation():
        ...
        cleanCovidData = covidData[["areaName", "date", "newCasesBySpecimenDate-0_4", "newCasesBySpecimenDate-5_9", \
                                        ...
                                        "newCasesBySpecimenDate-55_59", "newCasesBySpecimenDate-60_64", \
                                        "newCasesBySpecimenDate-65_69", "newCasesBySpecimenDate-70_74", \
                                        "newCasesBySpecimenDate-75_79", "newCasesBySpecimenDate-80_84", \
                                        "newCasesBySpecimenDate-85_89", "newCasesBySpecimenDate-90+", "newCasesBySpecimenDate-unassigned"] ].copy()
        ...
        highestAreaDf = sliceTable.groupby(["Daily_cases", "areaName"]).sum().unstack() #.sort_values('Total number of cases', ascending = False)
    ...
    def comapareAreas():
        ...
        rollingRateTable = covidDataa.drop(["newCasesBySpecimenDate-0_4", "newCasesBySpecimenDate-0_59", "newCasesBySpecimenDate-10_14",\
        "newCasesBySpecimenDate-15_19", "newCasesBySpecimenDate-20_24", "newCasesBySpecimenDate-25_29",\
        "newCasesBySpecimenDate-30_34", "newCasesBySpecimenDate-35_39", "newCasesBySpecimenDate-40_44",\
        "newCasesBySpecimenDate-45_49", "newCasesBySpecimenDate-50_54", "newCasesBySpecimenDate-55_59",\
        "newCasesBySpecimenDate-5_9", "newCasesBySpecimenDate-60+", "newCasesBySpecimenDate-60_64",\
        "newCasesBySpecimenDate-65_69","newCasesBySpecimenDate-70_74","newCasesBySpecimenDate-75_79",\
        "newCasesBySpecimenDate-80_84","newCasesBySpecimenDate-85_89","newCasesBySpecimenDate-90+", "newCasesBySpecimenDate-unassigned",\
        "newCasesBySpecimenDateRollingSum-0_4", "newCasesBySpecimenDateRollingSum-0_59", "newCasesBySpecimenDateRollingSum-10_14",\
        ...
        "newCasesBySpecimenDateRollingSum-5_9","newCasesBySpecimenDateRollingSum-60+","newCasesBySpecimenDateRollingSum-60_64",\
        ...
        "newCasesBySpecimenDateRollingSum-unassigned"], axis = 1, inplace = False)
        ...
        totalRedcarAndClevelandTable = redcarAndClevelandTable.sum(axis = 1, numeric_only = True)
        redcarAndClevelandTable['TotalRollingRate'] = totalRedcarAndClevelandTable
        fig, (ax0, ax1, ax2) = plt.subplots(nrows = 1, ncols = 3, sharey = True, figsize = (10, 66))
        ...
        redcarAndClevelandTable.plot(kind = "barh", y = "TotalRollingRate", x ="Week", ax = ax2)
        ...
        ax2.set(title = "Redcar and Cleveland Daily Cases", xlabel = "rolling rate", ylabel = "time")
        plt.show()
    def areasWithHighestRollingRates():
        ...
        cleanCovidData = covidData[["areaName", "date", \
                                "newCasesBySpecimenDateRollingRate-10_14", "newCasesBySpecimenDateRollingRate-15_19", "newCasesBySpecimenDateRollingRate-20_24", \
                                "newCasesBySpecimenDateRollingRate-25_29", "newCasesBySpecimenDateRollingRate-30_34", \
                                "newCasesBySpecimenDateRollingRate-35_39", "newCasesBySpecimenDateRollingRate-40_44", \
                                "newCasesBySpecimenDateRollingRate-45_49", "newCasesBySpecimenDateRollingRate-50_54", \
                                "newCasesBySpecimenDateRollingRate-55_59", "newCasesBySpecimenDateRollingRate-60_64", \
                                "newCasesBySpecimenDateRollingRate-65_69", "newCasesBySpecimenDateRollingRate-70_74", \
                                "newCasesBySpecimenDateRollingRate-75_79", "newCasesBySpecimenDateRollingRate-80_84", \
                                "newCasesBySpecimenDateRollingRate-85_89", "newCasesBySpecimenDateRollingRate-90+"] ]
    ...
    def compareAreasCumulativeSum():
        ...
        cumulativeSumTable = covidData.drop(["newCasesBySpecimenDate-0_4", "newCasesBySpecimenDate-0_59", "newCasesBySpecimenDate-10_14",\
        "newCasesBySpecimenDate-15_19", "newCasesBySpecimenDate-20_24", "newCasesBySpecimenDate-25_29",\
        "newCasesBySpecimenDate-30_34", "newCasesBySpecimenDate-35_39", "newCasesBySpecimenDate-40_44",\
        "newCasesBySpecimenDate-45_49", "newCasesBySpecimenDate-50_54", "newCasesBySpecimenDate-55_59",\
        "newCasesBySpecimenDate-5_9", "newCasesBySpecimenDate-60+", "newCasesBySpecimenDate-60_64",\
        "newCasesBySpecimenDate-65_69","newCasesBySpecimenDate-70_74","newCasesBySpecimenDate-75_79",\
        "newCasesBySpecimenDate-80_84","newCasesBySpecimenDate-85_89","newCasesBySpecimenDate-90+", "newCasesBySpecimenDate-unassigned",\
        "newCasesBySpecimenDateRollingRate-0_4", "newCasesBySpecimenDateRollingRate-0_59", "newCasesBySpecimenDateRollingRate-10_14",\
        ...
        "newCasesBySpecimenDateRollingRate-5_9","newCasesBySpecimenDateRollingRate-60+","newCasesBySpecimenDateRollingRate-60_64",\
        "newCasesBySpecimenDateRollingRate-65_69","newCasesBySpecimenDateRollingRate-70_74","newCasesBySpecimenDateRollingRate-75_79",\
        "newCasesBySpecimenDateRollingRate-80_84","newCasesBySpecimenDateRollingRate-85_89","newCasesBySpecimenDateRollingRate-90+"], axis = 1, inplace = False)
        ...
        ax2.set(title = "Stockton on Tees Daily Cases", xlabel = "Cumulative sum", ylabel = "time")
        plt.show()

    # create buttons   
    ttk.Button(covidWindow, text="Change in cases over date and location", command=changeInCasesOverTimeAndLocation).place(x=230, y=100)
    ttk.Button(covidWindow, text="Compare areas", command=comapareAreas).place(relx=0, rely=0.13)
    ttk.Button(covidWindow, text="Daily cases", command=totalDailyCases).place(relx=0, rely=0.26)
    ttk.Button(covidWindow, text="Weekly cases", command=totalWeeklyCases).place(relx=0, rely=0.39)
    ttk.Button(covidWindow, text="Monthly cases", command=totalMonthlyCases).place(relx=0, rely=0.52)
...
def openStopnSearch():
    ...
    def showClevelandNorthumbriaOutcome():
        northumbriaUrl = "https://data.police.uk/api/stops-force?force=northumbria&date=2021-06"
        clevelandUrl   = "https://data.police.uk/api/stops-force?force=cleveland&date=2021-06"
    ...
    #create datetime column
        clevelandDataset['datetime'] = pd.to_datetime(clevelandDataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
        northumbriaDataset['datetime'] = pd.to_datetime(northumbriaDataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
    # create month column
    ...
    #group by outcome and age range
        northumbriaAgeRange= northumbriaDataset.groupby(['outcome', 'age_range']).sum().unstack()
        clevelandAgeRange= clevelandDataset.groupby(['outcome', 'age_range']).sum().unstack()
    ...
    def getUrl(areaString, dateObj):
        return "https://data.police.uk/api/stops-force?force={}&date={}".format(areaString,dateObj)
...
#Read and load data in panada dataframe
        ...
        northumbriaJuneDataset['datetime'] = northumbriaJuneDataset.filter(['datetime']).applymap(lambda x: x[:x.find('T')])
        northumbriaJulyDataset['datetime'] = northumbriaJulyDataset.filter(['datetime']).applymap(lambda x: x[:x.find('T')])
        northumbriaAugustDataset ['datetime'] = northumbriaAugustDataset.filter(['datetime']).applymap(lambda x: x[:x.find('T')])

        clevelandJuneDataset ['datetime'] = clevelandJuneDataset.filter(['datetime']).applymap(lambda x: x[:x.find('T')])
        clevelandJulyDataset['datetime'] = clevelandJulyDataset.filter(['datetime']).applymap(lambda x: x[:x.find('T')])
        clevelandAugustDataset['datetime'] = clevelandAugustDataset.filter(['datetime']).applymap(lambda x: x[:x.find('T')])
        clevelandJuneDataset['datetime'] = pd.to_datetime(clevelandJuneDataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
        clevelandJulyDataset['datetime'] = pd.to_datetime(clevelandJulyDataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
        clevelandAugustDataset['datetime'] = pd.to_datetime(clevelandAugustDataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
        northumbriaJuneDataset['datetime'] = pd.to_datetime(northumbriaJuneDataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
        northumbriaJulyDataset['datetime'] = pd.to_datetime(northumbriaJulyDataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
        northumbriaAugustDataset['datetime'] = pd.to_datetime(northumbriaAugustDataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
#add week column
        ...
        clevelandSummerData = [clevelandJuneDataset, clevelandJulyDataset, clevelandAugustDataset]
        clevelandData = pd.concat(clevelandSummerData)
        #group table
        clevelandPoliceData= clevelandData.groupby(['week', "self_defined_ethnicity"]).count().unstack()
...
#Read and load data in panada dataframe
            northumbria2021Dataset['datetime'] = northumbria2021Dataset.filter(['datetime']).applymap(lambda x: x[:x.find('T')])
            northumbria2020Dataset['datetime'] = northumbria2020Dataset.filter(['datetime']).applymap(lambda x: x[:x.find('T')])
            northumbria2021Dataset['datetime'] = pd.to_datetime(northumbria2021Dataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
            northumbria2020Dataset['datetime'] = pd.to_datetime(northumbria2020Dataset['datetime'], format="%Y/%m/%d").sort_values(ascending = True)
#add week column
        ...
        #group table
            northumbriaData0= northumbria2021Dataset.groupby(['outcome', "self_defined_ethnicity"]).mean().unstack()
            northumbriaData1= northumbria2020Dataset.groupby(['outcome', "self_defined_ethnicity"]).mean().unstack()
...
#add week column
        ...
        #group table
            northumbriaData0= northumbria2021Dataset.groupby(['age_range', "gender"]).std().unstack()
            northumbriaData1= northumbria2020Dataset.groupby(['age_range', "gender"]).std().unstack()
...
stopNsearchBtn = tk.Button(root, text='view police stop and search', command=openStopnSearch)
covidButton.pack()
stopNsearchBtn.pack() 
root.mainloop()
